 ...
 * Author: Ahmad Paykli
 *
 * Created on February 10, 2026, 7:22 PM
 */
...
#define ADC_CONVERTER_DISABLE() (ADCON0bits.ADON = 1)
 ...
 */
#define ADC_ANALOG_DIGITAL_PORT_CONFIG(_conf) (ADCON1bits.PCFG = _conf)
